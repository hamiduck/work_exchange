...
public class AddEvaluationFragment extends Fragment {

    RecyclerView mrecyclerView;
    List<EvaluationListModel> userList;
    EvaluationListAdapter adapter;

    public AddEvaluationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_add_evaluation, container, false);
        initData();
